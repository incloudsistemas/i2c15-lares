...
use App\Filament\Tenant\Resources\Crm\Contacts\IndividualResource\Pages;
use App\Filament\Tenant\Resources\Crm\Contacts\IndividualResource\RelationManagers;
        ...
        return Forms\Components\Section::make(__('Infos. Gerais'))
            ...
            ->schema([
                ...
                Forms\Components\Select::make('legal_entities')
                    ->label(__('Empresa(s) relacionada(s)'))
                    ...
                    ->getOptionLabelsUsing(
                        ...
                        $service->getLegalEntityOptionLabels(values: $values),
                    )
                    ->multiple()
                    ...
                    ->when(
                        ...
                        $component->suffixAction(
                            ...
                            $service->quickCreateActionByContactLegalEntities(field: 'legal_entities', multiple: true),
                        ),
                    )
                    ->columnSpanFull(),
            ...
            ->actions([
                Tables\Actions\ActionGroup::make([
                    ...
                    Tables\Actions\DeleteAction::make()
                        ->label(__('Excluir'))
                        ->before(
                            fn(ContactService $service, Tables\Actions\DeleteAction $action, Individual $record) =>
